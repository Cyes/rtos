...
void spix_readwrite(void *value,int length)
{
	...
	HAL_SPI_Transmit(&hspi1,value,length,100);
	
#else

	HAL_SPI_Transmit_DMA(&hspi1,value,length);
...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_8|GPIO_PIN_9
	...
	HAL_GPIO_WritePin(GPIOA,GPIO_PIN_9,0); //LCD BLK 
 ...
 void MX_TIM7_Init(void)
{
  ...
  htim7.Init.Period = 3200 -1;//32000 = 1000hz
